...
Use the [GitHub Security Advisory](https://github.com/ktestify/ktestify-plugin-azureblob/security/advisories/new)
...
4. **Coordinated Disclosure** — we will notify you before the public release.
...
## Scope
This policy applies to the `ktestify-plugin-azureblob` library and its direct dependencies.  
